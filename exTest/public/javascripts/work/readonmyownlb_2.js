...
function handleData() {
  ...
  for (let i in beforePagesArr) {
    ...
    afterPagesArr[i].subtitle.push(beforePagesArr[i].info[0].subtitle);
    afterPagesArr[i].positionArr.push(beforePagesArr[i].info[0].position);

    let titleArr = beforePagesArr[i].info[0].subtitle.split(' ')
